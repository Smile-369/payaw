...
assert(bootstrap.includes("import('./player/PlayerApp')"), 'Separate Player App entry point is missing.');
...
const behavior = JSON.parse(execFileSync(process.execPath, [join(outputPath, 'tests', 'Milestone22Test.js')], { cwd: projectPath, encoding: 'utf8' }));
const result = {
