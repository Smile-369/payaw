...
const shell = readFileSync(join(projectPath, 'src', 'ui', 'CampaignStudioShell.ts'), 'utf8');
const css = readFileSync(join(projectPath, 'src', 'ui', 'campaign-studio-shell.css'), 'utf8');
...
const output = execFileSync(process.execPath, [join(outputPath, 'tests', 'StoryRemovalCommunityTest.js')], { cwd: projectPath, encoding: 'utf8' });
