...
assert(!source.includes('function renderBridgeList()'), 'Retired bridge list renderer should not remain in the editor application.');
assert(source.includes("bridgeForm.addEventListener('submit'"), 'Bridge authoring form integration is missing.');
...
execFileSync(process.execPath, [join(outputPath, 'tests', 'BridgeNetworkAuthoringTest.js')], { cwd: projectPath, stdio: 'inherit' });
