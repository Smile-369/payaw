...
assert(html.includes('id="project-import-file"'), 'Project JSON import control is missing.');
...
execFileSync(process.execPath, [join(outputPath, 'tests', 'WorldProjectRoundTripTest.js')], { cwd: projectPath, stdio: 'inherit' });
